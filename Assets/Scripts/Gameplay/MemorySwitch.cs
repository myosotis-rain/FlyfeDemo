...
namespace Flyfe.Gameplay
{
    ...
    public class MemorySwitch : MonoBehaviour, IInteractable, IResettable
    {
        ...
        [SerializeField] private bool triggerByEventOnly = false; 
        ...
        public void TurnOff()
        {
            ...
            if (HasParameter("SwitchTrigger")) _animator.SetTrigger(TriggerHash);
            else _animator.Play("TurnOff"); 
            
            onDeactivated.Invoke();
        }

        public void SetStateOn() => _currentState = SwitchState.On;
        public void SetStateOff() => _currentState = SwitchState.Off;
